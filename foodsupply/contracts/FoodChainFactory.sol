...
contract SupplyChainFactory {
    ...
    function createSupplyChain(string memory _supplyChainTitle) public {
        FoodSupplyChain newSupplyChain = new FoodSupplyChain(
            msg.sender,
            _supplyChainTitle
        );
...
contract FoodSupplyChain {
    ...
    uint256 public productExpiredDateInsertedOnChain;
    uint256 public productArrivalDateInsertedOnChain;
    string public madeWith;
    uint256 public madeWithInsertedOnChain;

    uint256 public productExpiredDay;
    uint256 public productExpiredMonth;
    uint256 public productExpiredYear;

    uint256 public productArrivalDay;
    uint256 public productArrivalMonth;
    uint256 public productArrivalYear;
    ...
    constructor(address manager, string memory _supplyChainTitle) {
    ...
    */
    ...
    function insertMadeWith(string memory _madeWith)
        public
        restrictedOnlyForManufacture
    {
        madeWith = _madeWith;
    ...
    function setProductExpiredDateOnChain()
        public
        restrictedOnlyForManufacture
    {
    ...
    function setProductArrivalDateOnChain()
        public
        restrictedOnlyForManufacture
    {
    ...
    {
        return (chains.length, manufactureAddress, supplyChainTitle);
    }
